					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{'backend/img/avatar2.jpg'}}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Megan Abott
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{'backend/img/avatar3.jpg'}}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Kate Ross
										     </span>
								...
								<li>
                                    <a href="#">
										<span class="avatar"><img src="{{'backend/img/avatar4.jpg'}}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{'backend/img/avatar5.jpg'}}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Jane Sanders
										     </span>
